...
robot.move(targetName, [0, -0.5, 0.2], None)
robot.move(targetName, [0, -0.5, -0.05], None)
robot.move(targetName, [0, -0.5, 0.2], None)
robot.move(targetName, [-0.5, 0, 0.2], None)
...
robot.move(targetName, [0, -0.6, 0.2], None)
robot.move(targetName, [0, -0.6, -0.05], None)
robot.move(targetName, [0, -0.6, 0.2], None)
robot.move(targetName, [-0.5, -0.1, 0.2], None)
robot.move(targetName, [-0.5, -0.1, -0.03], None)
robot.closeSucker(objectName, clouseParentObjectName)
robot.openSucker(objectName, openParentObjectName)
robot.move(targetName, [-0.5, -0.1, 0.2], None)

robot.move(targetName, [0, -0.4, 0.2], None)
robot.move(targetName, [0, -0.4, -0.04], None)
robot.move(targetName, [0, -0.4, 0.2], None)
robot.move(targetName, [-0.5, 0.1, 0.2], None)
robot.move(targetName, [-0.5, 0.1, -0.03], None)
robot.closeSucker(objectName, clouseParentObjectName)
...
robot.move(targetName, [0.1, -0.5, 0.2], None)
robot.move(targetName, [0.1, -0.5, -0.04], None)
robot.move(targetName, [0.1, -0.5, 0.2], None)
robot.move(targetName, [-0.4, 0, 0.2], None)
robot.move(targetName, [-0.4, 0, -0.03], None)
robot.closeSucker(objectName, clouseParentObjectName)
robot.openSucker(objectName, openParentObjectName)
robot.move(targetName, [-0.4, 0, 0.2], None)
...
robot.move(targetName, [-0.1, -0.5, -0.04], None)
robot.move(targetName, [-0.1, -0.5, 0.2], None)
robot.move(targetName, [-0.6, 0, 0.2], None)
robot.move(targetName, [-0.6, 0, -0.03], None)
robot.closeSucker(objectName, clouseParentObjectName)
robot.openSucker(objectName, openParentObjectName)
robot.move(targetName, [-0.6, 0, 0.2], None)
